...
```{r, fig1, fig.height=6, fig.width=8, fig.align='center', echo=F}

plot(MEbathy, border='grey')
# plot(yld, add=T, lwd=3, border='purple')
# plot(MEoutline, add=T, lwd=3, border='blue')
plot(MEoutline2, add=T, lty=1, lwd=2, border='black')
plot(MEcsv, add=T, col='purple')
legend('topleft', c('Depth samples', 'Original bathy contours'), pch=c(3,NA), lty=c(NA,1), col=c('purple', 'grey'), bty='n')
```


```{r, fig2, fig.width = 4.5, fig.align='center', fig.height=4, include=T }
...
# plot(data1.grid, border="grey")
# plot(MEoutline2, add=TRUE, col=NA, lwd=3)
# plot(MEcsv, add=TRUE, col="red", cex=0.5)
...
```{r, fig3, fig.width = 7.5, fig.align='center', fig.height=6, echo=F}
