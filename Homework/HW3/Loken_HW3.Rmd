...
plot(ME_500buffminus$geometry, add=T, col=NA,lty=3, lwd=2)
legend('topleft', c('Outer 500 m buffer', 'Inner 500 m buffer'), bty='n', lty=c(2,3), cex=1, lwd=2)
```

`st_buffer` creates a new polygon that all points are X distance away from the edge of another polygon. The buffer can extend outward (+) or inward (-).
...
7.45% of the expanded Lake Mendota polygong overlaps Lake Monona. 
